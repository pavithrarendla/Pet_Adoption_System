  ...
  const handleSubmit = async (e) => 
 {
  ...
  return (
    <div className="container mt-4">
       <h3 style={{ textAlign: "center",textDecoration: "underline"}}>Add Pet</h3>
      {
            message?
  ...
  <select className="form-control" name="category" onChange={handleChange} required>
    ...
    <option value="Electronics">DOG</option>
    <option value="Fashion">CAT</option>
    <option value="Books">SPARROW</option>
    <option value="Others">FISHES</option>
  </select>
</div>
